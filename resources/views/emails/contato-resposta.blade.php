                ...
                <table style="width: 580px; -webkit-text-size-adjust: 100%; -moz-text-size-adjust: 100%; text-size-adjust: 100%; mso-table-lspace: 0; mso-table-rspace: 0; border-collapse: separate; border-spacing: 0; table-layout: auto; border-radius: 8px; margin-top: 24px; padding: 0; border: 1px solid #eee;"
                    ...
                    <tr style="padding: 0;">
                        <td style="-webkit-text-size-adjust: 100%; -moz-text-size-adjust: 100%; text-size-adjust: 100%; mso-table-lspace: 0; mso-table-rspace: 0; border-collapse: collapse !important; -webkit-hyphens: auto; hyphens: auto; word-break: break-word; padding: 24px 32px 30px;"
                            ...
                            <p style="-webkit-text-size-adjust: 100%; -moz-text-size-adjust: 100%; text-size-adjust: 100%; font-size: 14px; margin: 0;">Prezado(a), <b>{{ $name ?? 'Sem Nome'}}</b></p>
                            <p style="-webkit-text-size-adjust: 100%; -moz-text-size-adjust: 100%; text-size-adjust: 100%; font-size: 14px; padding-bottom: 10px; margin: 0;">Agradecemos o seu contato!</p>

                            <p style="-webkit-text-size-adjust: 100%; -moz-text-size-adjust: 100%; text-size-adjust: 100%; font-size: 14px; padding-bottom: 10px; margin: 0; text-align: justify">Informamos que recebemos sua mensagem com sucesso e nossa equipe está analisando sua solicitação. Retornaremos o mais breve possível com a resposta adequada.</p>

                            <p style="-webkit-text-size-adjust: 100%; -moz-text-size-adjust: 100%; text-size-adjust: 100%; font-size: 14px; padding-bottom: 10px; margin: 0; text-align: justify">Caso tenha mais perguntas ou queira entrar em contato, utilize as informações abaixo!</p>
                        </td>
                    </tr>
                                            ...
                                            <tr style="padding: 0;">
                                                <td style="-webkit-text-size-adjust: 100%; -moz-text-size-adjust: 100%; text-size-adjust: 100%; mso-table-lspace: 0; mso-table-rspace: 0; border-collapse: collapse !important; -webkit-hyphens: auto; hyphens: auto; word-break: break-word; padding: 0;">
                                                    ...
                                                    <span class="signature-email"
                                                          style="color: #a3abb4; font-size: 10px;">comercial@devprod.com.br</span>
                                                </td>
                                            </tr>
                                        </table>
